...
<body>
  ...
  <section class="home">
    ...
    <div class="text">Test/assignment</div>
      ...
      <div class="grid-element sidepanel">
        <div class="row">
          <div class="col-sm-3" style="margin:10px 20px 10px 20px;">
            <div class="card">
              <div class="card-body">
                <h5 class="card-title">LINEAR EQUATIONS</h5>
                <p class="card-text">
                Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                </p>
                <a href="https://forms.gle/jwysDYfMS8y5u9U4A" class="btn btn-primary">Take test</a>
              </div>
            </div>
          </div>
            ...
            <div class="col-sm-3" style="margin:10px 20px 10px 20px;">
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="https://forms.gle/uaezkGSGstvoxaNz8" class="btn btn-primary">Take test</a>
                </div>
              </div>
            </div>
            <hr style="height:2px;border-width:0;color:gray;background-color:gray;margin:0px 20px 0px 20px">
